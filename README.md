...
- Power BI access tokens are never returned through MCP and never stored — they're handed out only via a single-use short-lived ticket redeemed by the client's query script, keeping live credentials out of conversation transcripts and off disk
